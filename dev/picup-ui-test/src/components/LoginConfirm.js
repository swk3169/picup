    ...
    <div className="LoginConfirm">
        <div className="form-group" align='center'>
          <textarea
              ...
              name="contents"
              resize="none"
              value="1. 개인정보의 처리 목적 ('http://localhost'이하 'Picup')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
              가. 홈페이지 회원가입 및 관리
