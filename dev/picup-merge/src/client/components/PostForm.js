...
class PostForm extends Component {
  ...
  async handleImageChange(e) {
    ...
    axios.post('http://localhost/classfication/image', formData)
    .then( (result) => {
  ...
  handleSubmit(e) {
    ...
    */
    ...
    .then( (result) => {
      console.log('/api/board/post done');
  ...
  renderPhotos(photos) { // data url
    ...
    return photos.map(async(photo, key) => {
      ...
      */
      ...
      if (photoStr.indexOf("image/jpeg") != -1 || photoStr.indexOf("image/png") != -1) {
        return (
          <li key={key}>
  ...
  render() {
    ...
    <div className="PostForm">
      ...
      <form onSubmit={ this.handleSubmit }>
        <div className="form-group post-group" align='right'>
        ...
        <div className="form-container" align='center'>
          <div className="form-group" align='center'>
            ...
            <div className="button">
              <button className="btn" onClick={this.onUploadClick.bind(this)}>사진 업로드</button>
            </div>
          </div>
        </div>
        <br/>
        ...
        <div className="form-group" align='center'>
          <button className={cx("btn canclebutton")} onClick={this.onClick.bind(this)}>취소</button>
          <button type="submit" className={cx("btn postbutton")}>
            작성
          </button>
        </div>
