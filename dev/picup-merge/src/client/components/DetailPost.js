...
class DetailPost extends Component {
  ...
  onModifyButtonClick(e) {
    ...
    this.setState({
      isModify: true,
      modifyContents: this.props.board.detailPost.postContents
    });
  }
  ...
  onConfirmButtonClick(e) {
    ...
    var contents = this.state.modifyContents;
    ...
    axios.put('/api/board/' + boardID + '/post/' + postID, body, config)
    .then( result => {
      console.log(result.data);
      if (result.data.data) {
        this.props.board.detailPost.postContents = this.state.modifyContents;
        this.setState({
          isModify: false,
        });
      }
  ...
  onDeleteButtonClick(e) {
    ...
    console.log('PostID:');
    console.log(postID);
    axios.delete('/api/board/' + boardID + '/post/' + postID, config )
    .then((result) => {
      console.log(result.data);
      ...
      return (
        <div className="dropdown" align='left'>
          ...
          <ul className="dropdown-menu">
            ...
            <li><a onClick={this.onModifyButtonClick.bind(this)}>게시물 수정</a></li>
            <li><a onClick={this.onDeleteButtonClick.bind(this)}>게시물 삭제</a></li>
          </ul>
        </div>
      )
    }
    ...
    if (this.state.isModify) {
      return (
        <div className='DetailPost'>
          ...
          <button className='btn btn-default btn-sm modifyBtn' onClick={this.onConfirmButtonClick.bind(this)}>확인</button>
          <button className='btn btn-default btn-sm modifyBtn' onClick={this.onCancleButtonClick.bind(this)}>취소</button>
        </div>
      );
    }
    else {
