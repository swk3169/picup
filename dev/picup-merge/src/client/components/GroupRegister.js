        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-container" align='center'>
            ...
            <div className="form-group form">
              <div className="input boardProfile">
                <input
                type="file"
                placeholder="Profile"
                accept="image/*"
          ...
          <br />
          <br />
          {this.state.boardProfile ? null : <span>그룹 프로필 사진을 업로드해주세요!</span>}
          <div className="form-group" align='center'>
            <input
              type="checkbox"
              placeholder="공개여부"
            ...
            <div align='center' className='caninvitecheck'>
            <CheckboxGroup
