...
class MOkButton extends Component {
  ...
  render() {
    return(
      <button className='btn btn-default btn-sm' onClick={this.onClick.bind(this)}>확인</button>
    )
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MOkButton)
